...
function AdminSidebar({menu}:PropsType) {
  return (
    ...
    <div className={`bg-color-indigo w-64 space-y-6 px-2 py-7 absolute inset-y-0 left-0 transform ${menu ? '':'invisible'} md:visible md:relative md:translate-x-0 transition duration-200 ease-in-out`}>
