...
function AdminSidebar({menu}:PropsType) {
  return (
    ...
    <div className={`bg-violet-700 w-72 space-y-6 py-7 absolute inset-y-0 left-0 transform ${menu ? '':'hidden'} md:block md:relative transition duration-200 ease-in-out`}>
